        ...
        {onAssigneeChange && users && (
          <div className="relative">
            <select
              ...
              className="h-9 rounded-xl border border-slate-200 bg-slate-50/80 px-3 text-xs font-semibold text-slate-700 outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 cursor-pointer"
            >
