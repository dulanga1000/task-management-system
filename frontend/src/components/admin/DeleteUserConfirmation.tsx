      ...
      <div className="w-full max-w-md rounded-2xl border border-slate-200/80 bg-white p-6 shadow-2xl">
        ...
        <div className="mt-6 flex items-center justify-end gap-2.5 border-t border-slate-100 pt-4">
          ...
          <button
            ...
            disabled={deleting}
            className="flex h-9 items-center justify-center rounded-xl bg-rose-600 px-4 text-xs font-semibold text-white shadow-xs hover:bg-rose-700 disabled:opacity-50 transition-all cursor-pointer"
          >
